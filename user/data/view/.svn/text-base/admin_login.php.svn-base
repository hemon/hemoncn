...
<div class="container">
	<form action="admin.php?m=user&a=login" method="post" id="loginform" target="_top">
		...
		<table class="mainbox">
			<tr>
				...
				<td class="login">
					...
					<p>验证码:<input type="text" name="seccode" class="txt" tabindex="2" id="seccode" value="" style="margin-right:5px;width:85px;" /><img title="如果您无法识别验证码，请点图片更换" onclick="this.src='admin.php?m=seccode&' + Math.random()" src="admin.php?m=seccode&<? echo rand();?>" class="checkcode" /></p>
...
<div class="footer">Powered by UCenter <?=UC_VERSION?> &copy; 2001 - 2008 <a href="http://www.comsenz.com/" target="_blank">Comsenz</a> Inc.</div>
