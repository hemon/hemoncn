	...
	<div class="container">
		<? if($status) { ?>
			<div class="<? if($status > 0) { ?>correctmsg<? } else { ?>errormsg<? } ?>">
				...
				<? } elseif($status == -4) { ?> /data/cache/config.inc.php 文件不可写
					...
					<tr>
						...
						<td>
							<ul class="dblist">
								...
								<li><input type="checkbox" name="allowadminnote" value="1" class="checkbox" checked="checked" />允许管理通知</li>
								<li><input type="checkbox" name="allowadmincache" value="1" class="checkbox" checked="checked" />允许管理缓存</li>
								<li><input type="checkbox" name="allowadminlog" value="1" class="checkbox" checked="checked" />允许管理日志</li>
							</ul>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td>
							<ul>
								...
								<li><input type="checkbox" name="allowadminnote" value="1" class="checkbox" <? if($admin['allowadminnote']) { ?> checked="checked" <? } ?>/>允许管理通知</li>
								<li><input type="checkbox" name="allowadmincache" value="1" class="checkbox" <? if($admin['allowadmincache']) { ?> checked="checked" <? } ?>/>允许管理缓存</li>
								<li><input type="checkbox" name="allowadminlog" value="1" class="checkbox" <? if($admin['allowadminlog']) { ?> checked="checked" <? } ?>/>允许管理日志</li>
							</ul>
						</td>
					</tr>
				</table>
