...
/*
	...
	$Id: editor.php 7222 2008-04-29 06:04:45Z zhengqingpeng $
*/
...
.tbri{width:70px;position:absolute;right:-3px;top:4px;background-position:0 -33px}
*:lang(zh) .tbri{top:2px;background-position:0 -31px}

.icons a{width:23px;height:23px;background-repeat:no-repeat;display:block;float:left;margin-right:3px;border:1px solid #efefef;border-top:1px solid #EFEFEF;border-bottom:1px solid #F2F3F2}
...
a.icoFsz{background-position:-111px 1px;margin-right:1px}
...
<textarea id="dvtext" style="height:91%;width:100%;border:0px;display:none;border-top:0px;padding:7px 4px 8px 8px;font-size:14px;font-family:Arial, Helvetica, sans-serif;line-height:150%"></textarea>
<div >
...
<div class="sepline"></div>
<a href="javascript:;" class="icoUrl" onClick="createLink();return false;" title="超链接"></a>
<a href="javascript:;" class="icoMoveUrl" onClick="clearLink();return false;" title="移除链接"></a>
<a href="javascript:;" class="icoImg" onClick="createImg();return false;" title="增加图片"></a>
<a href="javascript:;" class="icoSwf" onClick="createFlash();return false;" title="增加视频FLASH"></a>
...
<div id="fontface" class="eMenu" style="z-index:99;display:none;top:35px;left:2px;width:110px;height:230px">
...
<a href="javascript:;" onClick="fontname(this)" class="n" style="font:normal 12px '幼圆';">幼圆</a>
...
<a href="javascript:;" onClick="fontsize(4,this)" class="n" style="font-size:medium;line-height:120%;">中</a>
