...
/*
	...
	$Id: function_ftp.php 6565 2008-03-14 09:26:09Z liguode $
*/
...
function sftp_connect() {
	...
	if($ftpconnid = @$func($_SGLOBAL['setting']['ftphost'], $_SGLOBAL['setting']['ftpport'], 20)) {
