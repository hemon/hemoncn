...
/*
	...
	$Id: admincp_template.php 6565 2008-03-14 09:26:09Z liguode $
*/
...
//权限
if(!checkperm('managetemplate')) {
	cpmessage('no_authority_management_operation');
}

$turl = 'admincp.php?ac=template';
//模板目录
$tpldir = S_ROOT.'./template/'.$_SC['template'].'/';
...
if(submitcheck('editsubmit')) {
	...
	$tpl = strexists($filename,'/')?$filename:"template/$_SC[template]/$filename";
